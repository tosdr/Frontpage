...
abstract class LocalSvgRenderer implements RenderInterface {
    ...
    private function buildParameters(Badge $badge): array {
        ...
        $parameters['vendorWidth'] = $this->stringWidth($badge->getSubject()) + 20;
        $parameters['valueWidth'] = $this->stringWidth($badge->getStatus()) + 20;
        ...
        $parameters['vendorStartPosition'] = \round($parameters['vendorWidth'] / 2, 1) + 1 + 10;
