...
class Tags {
    ...
    public static function fetchAll() {
        ...
        $statement = self::$Database_Connection->prepare("SELECT * FROM Tags");
        $statement->execute();
    ...
    public static function exists($ID) {
        ...
        $statement = self::$Database_Connection->prepare("SELECT * FROM Tags WHERE ID = :ID");
    ...
    public static function fetchAllRandom(int $Limit = 100) {
        ...
        $statement = self::$Database_Connection->prepare("SELECT * FROM Tags ORDER BY RAND() LIMIT $Limit");
        $statement->execute();
