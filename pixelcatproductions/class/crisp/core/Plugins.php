...
class Plugins
{
     ...
     * @return bool
     */
    public static function installTranslations(string $PluginName, stdClass $PluginMetadata): bool
    {
        if (!is_object($PluginMetadata) && !isset($PluginMetadata->hookFile)) {
            return false;
        }
     ...
     * @return bool
     */
    public static function uninstallTranslations(string $PluginName, stdClass $PluginMetadata): bool
    {
        if (!is_object($PluginMetadata) && !isset($PluginMetadata->hookFile)) {
            return false;
        }
     ...
     * @return bool
     */
    public static function registerInstallHook(string $PluginName, mixed $Function): bool
    {
        if (is_callable($Function) || function_exists($PluginName)($Function)) {
