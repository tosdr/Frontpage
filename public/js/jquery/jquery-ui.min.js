/*
 ...
 http://jquery.org/license
*/
(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):d(jQuery)})(function(d){function R(a){for(var b;a.length&&a[0]!==document;){b=a.css("position");if("absolute"===b||"relative"===b||"fixed"===b)if(b=parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}return 0}function K(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass=
...
-1!==this.className.indexOf("ui-datepicker-next")&&d(this).removeClass("ui-datepicker-next-hover")}).on("mouseover","button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a",M)}function M(){d.datepicker._isDisabledDatepicker(F.inline?F.dpDiv.parent()[0]:F.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),
-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))}function G(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function E(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}d.ui=d.ui||{};d.ui.version="1.12.1";var S=0,N=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,e,f;for(f=0;null!=(e=b[f]);f++)try{(c=d._data(e,"events"))&&c.remove&&
...
0}},getWithinInfo:function(a){var b=d(a||window),c=d.isWindow(b[0]),e=!!b[0]&&9===b[0].nodeType;return{element:b,isWindow:c,isDocument:e,offset:c||e?{left:0,top:0}:d(a).offset(),scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:b.outerWidth(),height:b.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return n.apply(this,arguments);c=d.extend({},c);var q=d(c.of),l=d.position.getWithinInfo(c.within),u=d.position.getScrollInfo(l),p=(c.collision||"flip").split(" "),x={};var w=b(q);q[0].preventDefault&&
(c.at="left top");var v=w.width;var z=w.height;var H=w.offset;var B=d.extend({},H);d.each(["my","at"],function(){var a=(c[this]||"").split(" ");1===a.length&&(a=g.test(a[0])?a.concat(["center"]):h.test(a[0])?["center"].concat(a):["center","center"]);a[0]=g.test(a[0])?a[0]:"center";a[1]=h.test(a[1])?a[1]:"center";var b=k.exec(a[0]);var d=k.exec(a[1]);x[this]=[b?b[0]:0,d?d[0]:0];c[this]=[m.exec(a[0])[0],m.exec(a[1])[0]]});1===p.length&&(p[1]=p[0]);"right"===c.at[0]?B.left+=v:"center"===c.at[0]&&(B.left+=
v/2);"bottom"===c.at[1]?B.top+=z:"center"===c.at[1]&&(B.top+=z/2);var O=a(x.at,v,z);B.left+=O[0];B.top+=O[1];return this.each(function(){var b,g=d(this),h=g.outerWidth(),k=g.outerHeight(),m=parseInt(d.css(this,"marginLeft"),10)||0,n=parseInt(d.css(this,"marginTop"),10)||0,w=h+m+(parseInt(d.css(this,"marginRight"),10)||0)+u.width,r=k+n+(parseInt(d.css(this,"marginBottom"),10)||0)+u.height,t=d.extend({},B),C=a(x.my,g.outerWidth(),g.outerHeight());"right"===c.my[0]?t.left-=h:"center"===c.my[0]&&(t.left-=
h/2);"bottom"===c.my[1]?t.top-=k:"center"===c.my[1]&&(t.top-=k/2);t.left+=C[0];t.top+=C[1];var y={marginLeft:m,marginTop:n};d.each(["left","top"],function(a,b){if(d.ui.position[p[a]])d.ui.position[p[a]][b](t,{targetWidth:v,targetHeight:z,elemWidth:h,elemHeight:k,collisionPosition:y,collisionWidth:w,collisionHeight:r,offset:[O[0]+C[0],O[1]+C[1]],my:c.my,at:c.at,within:l,elem:g})});c.using&&(b=function(a){var b=H.left-t.left,d=b+v-h,m=H.top-t.top,u=m+z-k,l={target:{element:q,left:H.left,top:H.top,width:v,
height:z},element:{element:g,left:t.left,top:t.top,width:h,height:k},horizontal:0>d?"left":0<b?"right":"center",vertical:0>u?"top":0<m?"bottom":"middle"};v<h&&f(b+d)<v&&(l.horizontal="center");z<k&&f(m+u)<z&&(l.vertical="middle");e(f(b),f(d))>e(f(m),f(u))?l.important="horizontal":l.important="vertical";c.using.call(this,a,l)});g.offset(d.extend(t,{using:b}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,f=c.width,g=a.left-b.collisionPosition.marginLeft;
...
if("transparent"!==e&&("string"!==a.type(e)||(f=d(e)))){e=k(f||e);if(!n.rgba&&1!==e._rgba[3]){for(f="backgroundColor"===c?b.parentNode:b;(""===g||"transparent"===g)&&f&&f.style;)try{g=a.css(f,"backgroundColor"),f=f.parentNode}catch(B){}e=e.blend(g&&"transparent"!==g?g:"_default")}e=e.toRgbaString()}try{b.style[c]=e}catch(B){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,b.start.transition(b.end,b.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");
...
"hide",function(a,b){function c(){q.push(this);q.length===g*h&&(k.css({visibility:"visible"}),d(q).remove(),b())}var e,f,g=a.pieces?Math.round(Math.sqrt(a.pieces)):3,h=g,k=d(this),m="show"===a.mode,l=k.show().css("visibility","hidden").offset(),n=Math.ceil(k.outerWidth()/h),p=Math.ceil(k.outerHeight()/g),q=[];for(e=0;e<g;e++){var r=l.top+e*p;var u=e-(g-1)/2;for(f=0;f<h;f++){var t=l.left+f*n;var x=f-(h-1)/2;k.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",
...
e=a.mode,f="show"===e;e="hide"===e;var g=a.size||15,h=/([0-9]+)%/.exec(g),k=a.horizFirst?["right","bottom"]:["bottom","right"],m=a.duration/2,l=d.effects.createPlaceholder(c),n=c.cssClip(),p={clip:d.extend({},n)},q={clip:d.extend({},n)},r=[n[k[0]],n[k[1]]],u=c.queue().length;h&&(g=parseInt(h[1],10)/100*r[e?0:1]);p.clip[k[0]]=g;q.clip[k[0]]=g;q.clip[k[1]]=0;f&&(c.cssClip(q.clip),l&&l.css(d.effects.clipToBox(q)),q.clip=n);c.queue(function(b){l&&l.animate(d.effects.clipToBox(p),m,a.easing).animate(d.effects.clipToBox(q),
m,a.easing);b()}).animate(p,m,a.easing).animate(q,m,a.easing).queue(b);d.effects.unshift(c,u,4)});d.effects.define("highlight","show",function(a,b){var c=d(this),e={backgroundColor:c.css("backgroundColor")};"hide"===a.mode&&(e.opacity=0);d.effects.saveStyle(c);c.css({backgroundImage:"none",backgroundColor:a.color||"#ffff99"}).animate(e,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("size",function(a,b){var c=d(this),e=["fontSize"],f=["borderTopWidth","borderBottomWidth",
"paddingTop","paddingBottom"],g=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"];var h=a.mode;var k="effect"!==h,m=a.scale||"both";var l=a.origin||["middle","center"];var n=c.css("position"),p=c.position(),q=d.effects.scaledDimensions(c),r=a.from||q,u=a.to||d.effects.scaledDimensions(c,0);d.effects.createPlaceholder(c);"show"===h&&(h=r,r=u,u=h);var t=r.height/q.height;var x=r.width/q.width;var w=u.height/q.height;var v=u.width/q.width;if("box"===m||"both"===m)t!==w&&(r=d.effects.setTransition(c,
f,t,r),u=d.effects.setTransition(c,f,w,u)),x!==v&&(r=d.effects.setTransition(c,g,x,r),u=d.effects.setTransition(c,g,v,u));"content"!==m&&"both"!==m||t===w||(r=d.effects.setTransition(c,e,t,r),u=d.effects.setTransition(c,e,w,u));l&&(l=d.effects.getBaseline(l,q),r.top=(q.outerHeight-r.outerHeight)*l.y+p.top,r.left=(q.outerWidth-r.outerWidth)*l.x+p.left,u.top=(q.outerHeight-u.outerHeight)*l.y+p.top,u.left=(q.outerWidth-u.outerWidth)*l.x+p.left);c.css(r);if("content"===m||"both"===m)f=f.concat(["marginTop",
"marginBottom"]).concat(e),g=g.concat(["marginLeft","marginRight"]),c.find("*[width]").each(function(){var b=d(this),c=d.effects.scaledDimensions(b),e={height:c.height*t,width:c.width*x,outerHeight:c.outerHeight*t,outerWidth:c.outerWidth*x};c={height:c.height*w,width:c.width*v,outerHeight:c.height*w,outerWidth:c.width*v};t!==w&&(e=d.effects.setTransition(b,f,t,e),c=d.effects.setTransition(b,f,w,c));x!==v&&(e=d.effects.setTransition(b,g,x,e),c=d.effects.setTransition(b,g,v,c));k&&d.effects.saveStyle(b);
...
results:function(a){return a+(1<a?" results are":" result is")+" available, use up and down arrow keys to navigate."}}},__response:function(a){this._superApply(arguments);if(!this.options.disabled&&!this.cancelSearch){var b=a&&a.length?this.options.messages.results(a.length):this.options.messages.noResults;this.liveRegion.children().hide();d("<div>").text(b).appendTo(this.liveRegion)}}});var T=/ui-corner-([a-z]){2,6}/g;d.widget("ui.controlgroup",{version:"1.12.1",defaultElement:"<div>",options:{direction:"horizontal",
...
this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,e,f){a=this._dialogInst;a||(this.uuid+=1,a="dp"+this.uuid,this._dialogInput=d("<input type='text' id='"+a+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.on("keydown",this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));G(a.settings,e||{});b=b&&b.constructor===Date?
...
this._daylightSavingAdjust(new Date(w,p-q,1)),this._getFormatConfig(a)):v;v=this._canAdjustMonth(a,-1,w,p)?"<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+v+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"e":"w")+"'>"+v+"</span></a>":m?"":"<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+v+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"e":"w")+"'>"+v+"</span></a>";var z=this._get(a,"nextText");z=l?this.formatDate(z,this._daylightSavingAdjust(new Date(w,
p+q,1)),this._getFormatConfig(a)):z;m=this._canAdjustMonth(a,1,w,p)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+z+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"w":"e")+"'>"+z+"</span></a>":m?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+z+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"w":"e")+"'>"+z+"</span></a>";q=this._get(a,"currentText");z=this._get(a,"gotoCurrent")&&a.currentDay?u:g;q=l?this.formatDate(q,
z,this._getFormatConfig(a)):q;l=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+"</button>";k=k?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(h?l:"")+(this._isInRange(a,z)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+q+"</button>":"")+(h?"":l)+"</div>":
"";l=parseInt(this._get(a,"firstDay"),10);l=isNaN(l)?0:l;q=this._get(a,"showWeek");z=this._get(a,"dayNames");var H=this._get(a,"dayNamesMin");var B=this._get(a,"monthNames");var F=this._get(a,"monthNamesShort");var E=this._get(a,"beforeShowDay");var G=this._get(a,"showOtherMonths");var I=this._get(a,"selectOtherMonths");var J=this._getDefaultDate(a);var K="";for(b=0;b<n[0];b++){var L="";this.maxRows=4;for(c=0;c<n[1];c++){var M=this._daylightSavingAdjust(new Date(w,p,a.selectedDay));var A=" ui-corner-all";
var D="";if(r){D+="<div class='ui-datepicker-group";if(1<n[1])switch(c){case 0:D+=" ui-datepicker-group-first";A=" ui-corner-"+(h?"right":"left");break;case n[1]-1:D+=" ui-datepicker-group-last";A=" ui-corner-"+(h?"left":"right");break;default:D+=" ui-datepicker-group-middle",A=""}D+="'>"}D+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+A+"'>"+(/all|left/.test(A)&&0===b?h?m:v:"")+(/all|right/.test(A)&&0===b?h?v:m:"")+this._generateMonthYearHeader(a,p,w,t,x,0<b||0<c,B,F)+"</div><table class='ui-datepicker-calendar'><thead><tr>";
var C=q?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(A=0;7>A;A++){var y=(A+l)%7;C+="<th scope='col'"+(5<=(A+l+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+z[y]+"'>"+H[y]+"</span></th>"}D+=C+"</tr></thead><tbody>";C=this._getDaysInMonth(w,p);w===a.selectedYear&&p===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,C));A=(this._getFirstDayOfMonth(w,p)-l+7)%7;C=Math.ceil((A+C)/7);this.maxRows=C=r?this.maxRows>C?this.maxRows:C:C;y=this._daylightSavingAdjust(new Date(w,
p,1-A));for(d=0;d<C;d++){D+="<tr>";var N=q?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(y)+"</td>":"";for(A=0;7>A;A++){var P=E?E.apply(a.input?a.input[0]:null,[y]):[!0,""];var Q=(f=y.getMonth()!==p)&&!I||!P[0]||t&&y<t||x&&y>x;N+="<td class='"+(5<=(A+l+6)%7?" ui-datepicker-week-end":"")+(f?" ui-datepicker-other-month":"")+(y.getTime()===M.getTime()&&p===a.selectedMonth&&a._keyEvent||J.getTime()===y.getTime()&&J.getTime()===M.getTime()?" "+this._dayOverClass:"")+(Q?" "+this._unselectableClass+
" ui-state-disabled":"")+(f&&!G?"":" "+P[1]+(y.getTime()===u.getTime()?" "+this._currentClass:"")+(y.getTime()===g.getTime()?" ui-datepicker-today":""))+"'"+(f&&!G||!P[2]?"":" title='"+P[2].replace(/'/g,"&#39;")+"'")+(Q?"":" data-handler='selectDay' data-event='click' data-month='"+y.getMonth()+"' data-year='"+y.getFullYear()+"'")+">"+(f&&!G?"&#xa0;":Q?"<span class='ui-state-default'>"+y.getDate()+"</span>":"<a class='ui-state-default"+(y.getTime()===g.getTime()?" ui-state-highlight":"")+(y.getTime()===
u.getTime()?" ui-state-active":"")+(f?" ui-priority-secondary":"")+"' href='#'>"+y.getDate()+"</a>")+"</td>";y.setDate(y.getDate()+1);y=this._daylightSavingAdjust(y)}D+=N+"</tr>"}p++;11<p&&(p=0,w++);D+="</tbody></table>"+(r?"</div>"+(0<n[0]&&c===n[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");L+=D}K+=L}a._keyEvent=!1;return K+k},_generateMonthYearHeader:function(a,b,c,d,f,g,h,k){var e,l=this._get(a,"changeMonth"),n=this._get(a,"changeYear"),p=this._get(a,"showMonthAfterYear"),q="<div class='ui-datepicker-title'>",
r="";if(g||!l)r+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;var u=f&&f.getFullYear()===c;r+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(e=0;12>e;e++)(!h||e>=d.getMonth())&&(!u||e<=f.getMonth())&&(r+="<option value='"+e+"'"+(e===b?" selected='selected'":"")+">"+k[e]+"</option>");r+="</select>"}p||(q+=r+(!g&&l&&n?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!n)q+="<span class='ui-datepicker-year'>"+c+"</span>";
