...
\crisp\core\Theme::addtoNavbar("new_service", crisp\api\Translation::fetch("components.navbar.request_service"), \crisp\api\Helper::generateLink("request_service"), "_self", -96);
